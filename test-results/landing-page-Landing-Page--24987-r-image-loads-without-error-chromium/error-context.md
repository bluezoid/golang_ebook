...
- Name: landing-page.spec.ts >> Landing Page >> book cover image loads without error
- Location: tests/e2e/landing-page.spec.ts:19:7
...
Locator: getByAltText('Deep Dive Into Go — book cover')
Expected: visible
Error: strict mode violation: getByAltText('Deep Dive Into Go — book cover') resolved to 2 elements:
    1) <img width="700" height="640" data-nimg="1" loading="eager" decoding="async" fetchpriority="high" class="w-full h-auto object-cover" alt="Deep Dive Into Go — book cover" src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fbook-cover.0v86647p1brd1.jpg&w=1920&q=75" srcset="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fbook-cover.0v86647p1brd1.jpg&w=750&q=75 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fbook-cover.0v86647p1brd1.jpg&w=1920&q=75 2x"/> aka locator('section').filter({ hasText: 'First Edition — 2025 · Go 1.' }).locator('img')
    2) <img width="700" height="640" data-nimg="1" loading="lazy" decoding="async" class="w-full h-auto object-cover" alt="Deep Dive Into Go — book cover" src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fbook-cover.0v86647p1brd1.jpg&w=1920&q=75" srcset="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fbook-cover.0v86647p1brd1.jpg&w=750&q=75 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fbook-cover.0v86647p1brd1.jpg&w=1920&q=75 2x"/> aka locator('section').filter({ hasText: 'Free PreviewRead 100' }).locator('img')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByAltText('Deep Dive Into Go — book cover')
