...
- Name: success-page.spec.ts >> Success Page >> shows already_fulfilled message
- Location: tests/e2e/success-page.spec.ts:31:7
...
Locator: getByText(/already processed/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/already processed/i)
