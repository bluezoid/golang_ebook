...
- Name: purchase-flow.spec.ts >> Purchase Flow >> API error shows error message in modal
- Location: tests/e2e/purchase-flow.spec.ts:135:7
    ...
    - generic [ref=e882]:
      ...
      - generic [ref=e900]:
        ...
        - generic [ref=e908]:
          ...
          - textbox "Email Address" [active] [ref=e910]:
          ...
          - generic [ref=e917]:
            - generic [ref=e918]:
              - combobox "Phone number country" [ref=e919] [cursor=pointer]:
                ...
                - option "Zimbabwe"
              - img [ref=e921]
            - textbox "Mobile Number" [ref=e923]: "+91"
